...
async def start_feedback(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Ми намагалися зробити <b>Інженерний Ярмарок Карʼєри</b> якомога кориснішим і цікавим для тебе. А тепер твоя черга допомогти нам стати кращими! Оціни, будь ласка, захід від 1 до 5 📊.",
        parse_mode="HTML",
