...
speakers = [
    ...
    },
    {
        ...
        "description": "🔹 HR Generalist у Kevych Solutions\n\n🔹 Модератор | Панельна дискусія «Робота після університету: чого не вистачає випускникам?»",
        "key": "andrewkha"
    }
]
...
async def show_ukraine_support(message: types.Message):
    ...
    caption = (
        "<b>15-й збір від BEST LVIV? Це повинно бути потужно!⚡</b>\n\n"
        "👥 Волонтери об'єднуються, щоб ще більше допомагати військовим. Тому доєднуємося до збору <a href='https://www.instagram.com/grateful_vdiachni/'>@grateful_vdiachni</a> – благодійного фонду, що допомагає медикам з ресурсами для евакуації поранених.\n\n"
        "🚑 На що збираємо? На встановлення протидронових сіток для евакуаційного автомобілю для медичної роти 67 ОМБ.\n\n"
        "💥 Наша ціль: 65 тис. грн\n\n"
        "💳 Номер картки банку: <code>4441 1111 2456 4273</code>\n\n"
        "Посилання на збір знаходиться в шапці <a href='https://www.instagram.com/p/DIloK3-gU4t/?img_index=1'>профілю</a>!\n\n"
        "Дякуємо всім, хто донатить! Ви неймовірні!\n\n"
        "Не зупиняйтесь, адже медикам на фронті теж потрібна наша підтримка. 🫂"
    )
    photo = FSInputFile(photo_path)
    await message.answer_photo(
        photo=photo,
