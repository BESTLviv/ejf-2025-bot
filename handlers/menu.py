...
async def share_and_win(message: types.Message):
    ...
    "🔹 Зроби знімок з роботом від <i>Leoni</i> і поділись у соцмережах та горнятка від <i>Leoni</i>\n"
    ...
    "📌 <b>Завдання від <u>BEST Lviv</u>:</b>\n"
    "🔹 Зроби фото біля сцени та виклади його у Stories з позначкою @best_lviv — покажи, як ти запалюєш!\n"
    "🔹 Виконай завдання біля інфозони BEST Lviv, зроби фото та поділись ним у Stories, також познач @best_lviv\n\n",
...
async def start_feedback(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Інженерний Ярмарок Кар’єри ще триває, але ми вже хочемо дізнатися твою думку! Ми намагалися зробити захід якомога кориснішим і цікавішим для тебе. А тепер твоя черга допомогти нам стати ще кращими — оціни, будь ласка, ярмарок від 1 до 5 📊",
        parse_mode="HTML",
