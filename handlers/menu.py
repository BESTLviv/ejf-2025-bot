...
async def share_and_win(message: types.Message):
    ...
    await message.answer( 
        ...
        "🔹 Відвідати інтерактив від  PwC Lviv SDC та викласти фото з позначкою сторінок @pwc_lviv_sdc та @best_lviv\n\n"
        "🔹 Дайте відповідь на питання від Kevych Solutions\n\n"
        "🔹 Дайтe відповідь на питання від Kpmg\n\n"
        "🔹 Відповісти на запитання від компанії Renesas\n\n"
        "🔹 Дайте відповідь на питання від Coxit\n\n"
        "🔹 Дайте відповідь на питання від Lifesaver\n\n"
        "🔹 Cфотографуйтесь та викладіть фото з роботом від Leoni\n\n"
        "🔹 \"Знайди свій soft skill\"від Сlario tech\n\n"
        "🔹 Пройти опитування/kahoot від Globallogic\n\n"
        "🔹 Відвідати воркшоп від компанії Infineon\n\n"
        "🔹 Задача від компанії Coax\n\n"
        "🔹 Зробити фото біля фотозони Ukrsibbank та розмістити його з позначкою @ukrsibbank в соц. мережах\n\n",
