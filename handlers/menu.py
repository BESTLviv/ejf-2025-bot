...
async def show_ukraine_support(message: types.Message):
    ...
    caption = (
        ...
        "👥 Волонтери об'єднуються, щоб ще більше допомагати військовим. Тому доєднуємося до збору @grateful_vdiachni – благодійного фонду, що допомагає медикам з ресурсами для евакуації поранених.\n\n"
