...
async def show_ukraine_support(message: types.Message):
    ...
    caption = (
        # "<b>Серце, яке ми показуємо — не просто жест. Це вдячність тим, завдяки кому воно бʼється.</b>\n\n"
        ...
        "<a href='https://send.monobank.ua/jar/87vmuFGKQL'>Долучитись можна за посиланням тут!</a>\n\n" 
        "А щоб підтримка була ще приємнішою — <b>кожні 50 грн дають шанс виграти подарунок.</b>"
